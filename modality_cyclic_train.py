...
if __name__ == "__main__":
    ...
    parser.add_argument("--filter_train", help="a npy to filter data based on pixel difference and mask difference", type=str, default='/mnt/data/data/OxAAA/train/normalized/nonemptymaskstrain_folders.npy')
    parser.add_argument("--filter_val", help="a npy to filter data based on pixel difference and mask difference", type=str, default='/mnt/data/data/OxAAA/train/normalized/nonemptymasksval_folders.npy')
